...
#
# Created: Wed Nov 14 16:47:31 2012
...
class Ui_BBA(object):
    def setupUi(self, BBA):
        ...
        self.widget.setGeometry(QtCore.QRect(1, 1, 281, 411))
        ...
        self.widget1.setGeometry(QtCore.QRect(310, 10, 151, 121))
        ...
        self.cB_totalIntensity = QtGui.QCheckBox(self.widget1)
