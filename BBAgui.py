...
#
# Created: Mon Dec 10 17:54:18 2012
...
class Ui_BBA(object):
    def setupUi(self, BBA):
        ...
        self.cB_convertjpg = QtGui.QCheckBox(self.layoutWidget1)
        ...
        self.cB_totalIntensity = QtGui.QCheckBox(self.layoutWidget1)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pB_Calculate = QtGui.QPushButton(self.layoutWidget1)
        self.pB_Calculate.setObjectName(_fromUtf8("pB_Calculate"))
        self.verticalLayout_2.addWidget(self.pB_Calculate)
        self.saveResults = QtGui.QPushButton(self.layoutWidget1)
